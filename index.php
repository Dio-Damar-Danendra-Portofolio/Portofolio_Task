	      ...
	      <div class="slider-item ">
	        ...
	        <div class="container">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third js-fullheight order-md-last img" style="background-image:url(images/Dio_DD.png);">
	          		<div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">Halo!</span>
			            <h1 class="mb-4 mt-3">Nama saya <span>Dio Damar Danendra</span></h1>
			            <h2 class="mb-4">sebagai Programmer di PT Spesial Karya Mandiri</h2>
			            <p><a href="#" class="btn btn-primary py-3 px-4">Rekrut saya!</a> 
                            <a href="#" class="btn btn-white btn-outline-white py-3 px-4">Hasil kerja saya</a></p>
		            </div>
		          </div>
	        	</div>
	        </div>
	        ...
	        <div class="container">
	          <div class="row d-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">Halo!</span>
			            <h1 class="mb-4 mt-3">Saya adalah <span>app developer</span> dan <span>web developer</span></h1>
    		...
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
    					<div class="overlay"></div>
	    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(images/Dio_DD.png);">
	    				</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		          	<h1 class="big">Tentang Saya</h1>
		            <h2 class="mb-4">Biodata saya</h2>
		            <p>Ini merupakan biodata atau data pribadi saya.</p>
		            <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex"><span>Nama:</span> <span>Dio Damar Danendra</span></li>
		            	<li class="d-flex"><span>Tanggal Lahir:</span> <span>14 Oktober 2000</span></li>
		            	<li class="d-flex"><span>Alamat:</span> <span>Jl. Mertilang XI Blok KB</span></li>
